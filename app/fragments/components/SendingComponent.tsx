...
export const SendingComponent = React.memo(() => {
                ...
                <div className='loader'>
                    <svg height="100%" viewBox="0 0 160 160" width="100%">
                        <circle
                            ...
                            strokeWidth="5"
                            style={{
                                stroke: Config.testnet ? '#F1A03A' : 'rgb(26, 149, 224)',
                                opacity: 0.2,
                            }}
                        />
                        <circle
