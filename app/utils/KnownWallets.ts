...
const Img_Whales = require('../fragments/components/images/whales.png').default.src;
const Img_OKX = require('../fragments/components/images/okx.png').default.src;
const Img_FTX = require('../fragments/components/images/ftx.png').default.src;
